...
public class App {
    public static String imprimeData(String dat, String[] ext) {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String[] escrito_por_extenso = new String[3];
        String data = "";

        do {
            System.out.print("Digite qualquer data no padrão dd/mm/aaaa: ");
        ...
        teclado.close();
        System.out.println(imprimeData(data, escrito_por_extenso));
    }
